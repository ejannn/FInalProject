...
int checkCredentials(char *username, char *password)
{
    ...
    if (strcmp(username, "nieljhon") == 0 && strcmp(password, "nieljhon") == 0)
    {
        return 1;
    }
    else
...
void logIn()
{
    ...
    {gotoxy(50, 13);printf("\033[32m╔════════════════════════════════════════════════════════════════════╗\n\033[0m");
     gotoxy(50, 14);printf("\033[32m║                                      \033[0;36m(•̀ᴗ•́ )و                       ║\n\033[0m");
     gotoxy(50, 15);printf("\033[32m║    \033[0;33mLog-In To The System :\033[0m                           \033[0;35m(੭｡╹▿╹｡)੭\033[0m      ║\n\033[0m");
     gotoxy(50, 16);printf("\033[32m║                                                                    ║\n\033[0m");
     gotoxy(50, 17);printf("\033[32m║                                                                    ║\n\033[0m");
     gotoxy(50, 18);printf("\033[32m║    \033[0;37mEnter your username:\033[0m  \033[0;33m✔✔✔✔✔✔✔\033[0m     \033[32m(๑ > ᴗ <๑)\033[0m                    ║\n\033[0m");
     gotoxy(50, 19);printf("\033[32m║                                                                    ║\n\033[0m");
     gotoxy(50, 20);printf("\033[32m║    \033[0;37mEnter your password:\033[0m  \033[0;33m✔✔✔✔✔✔✔\033[0m                   \033[0;36m(❀❛ ֊ ❛„)♡\033[0m      ║\n\033[0m");
     gotoxy(50, 21);printf("\033[32m║                                                                    ║\n\033[0m");
     gotoxy(50, 22);printf("\033[32m║                                                                    ║\n\033[0m");
     gotoxy(50, 23);printf("\033[32m║                                                                    ║\n\033[0m");
     gotoxy(50, 24);printf("\033[32m║                                                                    ║\n\033[0m");
     gotoxy(50, 25);printf("\033[32m╚════════════════════════════════════════════════════════════════════╝\n\033[0m");
        gotoxy(55, 23);
        printf("\033[0;34mLog in successful. Press any Key to Continue.\033[0m");
        getch();
        system("cls");
        mainMenu();
    }
    ...
    {gotoxy(50, 13);printf("\033[1;31m╔════════════════════════════════════════════════════════════════════╗\n\033[0m");
     gotoxy(50, 14);printf("\033[1;31m║                                                                    ║\n\033[0m");
     gotoxy(50, 15);printf("\033[1;31m║    \033[0;35mLog-In To The System :\033[0m                                          ║\n\033[0m");
     gotoxy(50, 16);printf("\033[1;31m║                                                    \033[0;33mNAAAAhh!!\033[0m       ║\n\033[0m");
     gotoxy(50, 17);printf("\033[1;31m║                                                                    ║\n\033[0m");
     gotoxy(50, 18);printf("\033[1;31m║    \033[0;37mEnter your username:\033[0m \033[1;31m!!!!!!!!!!!\033[0m             SAD (T-T)          ║\n\033[0m");
     gotoxy(50, 19);printf("\033[1;31m║                                                     \033[0;34m(╥﹏╥)\033[0m         ║\n\033[0m");
     gotoxy(50, 20);printf("\033[1;31m║    \033[0;37mEnter your password:\033[0m \033[1;31m!!!!!!!!!!!\033[0m                                ║\n\033[0m");
     gotoxy(50, 21);printf("\033[1;31m║                                                 \033[1;31m(  •̀ - •́  )\033[0m        ║\n\033[0m");
     gotoxy(50, 22);printf("\033[1;31m║                \033[0;35m<( ⸝⸝•̀ - •́⸝⸝)>\033[0m                                      ║\n\033[0m");
     gotoxy(50, 23);printf("\033[1;31m║                                                                    ║\n\033[0m");
     gotoxy(50, 24);printf("\033[1;31m║                                                                    ║\n\033[0m");
     gotoxy(50, 25);printf("\033[1;31m╚════════════════════════════════════════════════════════════════════╝\n\033[0m");
        gotoxy(55, 24);
...
void pattern3()
{
        ...
        gotoxy(50, 15);printf("║                          ║");
        gotoxy(50, 16);printf("║        N                 ║");
        gotoxy(50, 17);printf("║        NI                ║");
        gotoxy(50, 18);printf("║        NIE               ║");
        gotoxy(50, 19);printf("║        NIEL              ║");
        gotoxy(50, 20);printf("║        NIELJ             ║");
        gotoxy(50, 21);printf("║        NIELJH            ║");
        gotoxy(50, 22);printf("║        NIELJHO           ║");
        gotoxy(50, 23);printf("║        NIELJHON          ║");
        gotoxy(50, 24);printf("║    \033[32mPress any Key to\033[0m      ║");
        gotoxy(50, 25);printf("║        \033[32mContinue...\033[0m       ║");
        gotoxy(50, 26);printf("╚══════════════════════════╝\n");
    getch();
    system("cls");    
}
